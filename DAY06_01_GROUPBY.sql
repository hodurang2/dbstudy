/*
    ...
    3. SELECT 절에서 조회하려는 칼럼은 반드시 GROUP BY 절에 명시 되어있어야 한다
*/
...
-- 3. 3자리가 같은 사원들을 그룹화하여 각 그룹별로 연봉의 합계가 얼마인지 조회하시오.
SELECT PHONE_NUMBER,
       SUM(SALARY)
  FROM EMPLOYEES
 GROUP BY SUBSTR(PHONE_NUMBER, 1, 3);
-- 참고 GROUP BY 없이 통계값 추론하기.
...
/*
    ...
    3. GROUP BY 절이 필요하지 않는 조건은 WHERE절로 지정 가능.  -> 성능에 영향이감
*/
